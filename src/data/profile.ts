export const profile = {
  name: 'Francisco Matías Molina Jurado',
  shortName: 'Francisco Molina',
  role: 'Desarrollador Back-End',
  specialization: 'Java · Spring Boot · Python · Integración de datos',
  location: 'Roquetas de Mar, Almería, España',
  email: 'francisco.fm34@gmail.com',
  website: 'franciscomolina.me',
  github: 'https://github.com/PacoMatias89',
  githubUser: 'PacoMatias89',
  linkedin: 'https://www.linkedin.com/in/francisco-mat%C3%ADas-molina-jurado/',
  linkedinUser: 'francisco-matías-molina-jurado',
  about: [
    ...
    'Trabajo con rigor técnico, metodología ágil y atención al diseño limpio del código. Valoro la claridad, la mantenibilidad y la entrega de soluciones que realmente funcionen.',
  ],
};
